...
import {isFillHeatmapStyleLayer} from '../style/style_layer/fill_heatmap_style_layer';
...
export class Painter {
    ...
    renderLayer(painter: Painter, tileManager: TileManager, layer: StyleLayer, coords: OverscaledTileID[], renderOptions: RenderOptions) {
        ...
        } else if (isFillHeatmapStyleLayer(layer)) {
            draw.fillHeatmap(painter, tileManager, layer, coords, renderOptions);
