...
import fillHeatmapFrag from './glsl/fill_heatmap.fragment.glsl.g';
import fillHeatmapVert from './glsl/fill_heatmap.vertex.glsl.g';
import fillHeatmapTextureFrag from './glsl/fill_heatmap_texture.fragment.glsl.g';
import fillHeatmapTextureVert from './glsl/fill_heatmap_texture.vertex.glsl.g';
...
export const shaders = {
    ...
    fillHeatmap: prepare(fillHeatmapFrag, fillHeatmapVert),
    fillHeatmapTexture: prepare(fillHeatmapTextureFrag, fillHeatmapTextureVert),
